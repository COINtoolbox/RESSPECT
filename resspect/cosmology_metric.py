...
if __name__ == "__main__":
    ...
    parser.add_argument('--sorted', dest='sort_update.',
                        action='store_true',
                        default=False,
    ...
    parser.add_argument('--comp_data', dest='comparison_data', type=str,
                        help='Second dataset to compare.')

    parser.add_argument('--update_data', dest='update_data', type=str,
                        help='data to use to update the fisher matrix.')

    parser.add_argument('-t', dest='total_update',
                        action='store_true',
                        default=False,
                        help='Print the total uncertainty update if all objects included.')

    parser.add_argument('--no_save', dest='save_file',
                        action='store_false',
                        default=True,
                        help='Print the total uncertainty update if all objects included.')

    parser.add_argument('--output', dest='output', type=str,
                        default='cosmology_metric_output.txt',
    ...
    if args.update_data:
        new_data = pd.read_csv(args.update_data, delimiter=' ')
